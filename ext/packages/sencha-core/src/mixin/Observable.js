...
Ext.define('Ext.mixin.Observable', function(Observable) {
    ...
    return {
        ...
        */
         ...
         *
         * @param {Function} [fn] The method the event invokes or the *name* of the method within
         ...
         *             },
         *             scope: altCmp // unique scope for the destory handler
         *         },
         ...
         *
         * You must go directly through the element to unattach an event handler attached using
